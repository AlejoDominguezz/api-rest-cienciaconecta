export const altaMailHtml = (docente) => `
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="outer-container">
    <div class="shadow">
      <div class="container">
        ...
        <p class="black-text" style="font-size: 16px;">Te informamos que tu cuenta para la Feria de Ciencias y Tecnología ha sido dada de alta.</p>
        <p class="black-text" style="font-size: 16px;">El número de CUIL asociado a tu cuenta es: ${docente.cuil}</p>
        <p style="font-size: 14px; color: #888; margin-top: 20px;">Ya podés ingresar a tu cuenta y acceder a las funcionalidades de CienciaConecta.</p>
