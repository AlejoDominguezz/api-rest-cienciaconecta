...
import { checkRolAuth, esEvaluadorDelProyecto, esPropietario, esReferenteDelProyecto } from "../middlewares/validar-roles.js";
...
routerProyectos.get(
  "/download/:id",
    requireToken,
    BodyValidationDrive,
    checkRolAuth([roles.admin, roles.responsableProyecto, roles.comAsesora, roles.evaluador]),
    esPropietario,
